"""
Django settings for penTracker project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'pen-tracker.onrender.com']
...
WSGI_APPLICATION = 'penTracker.wsgi.application'
